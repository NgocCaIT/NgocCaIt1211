  ...
  <title>Điện Thoại Di Động</title>
    ...
    <div class="login">
      ...
      <form method="post" action="Signup">
        <p><input type="text" name="userr" value="<%=Model.Signup.userr%>" placeholder="Username or Email"></p>
        <p><input type="password" name="passs" value="<%=Model.Signup.passs%>" placeholder="Password"></p>
        <p><input type="text" name="hotenn" value="<%=Model.Signup.hotenn%>" placeholder="Full Name"></p>
        <p><input type="text" name="sodtt" value="<%=Model.Signup.sodtt%>" placeholder="Enter Phone"></p>
        <p><input type="text" name="diachii" value="<%=Model.Signup.diachii%>" placeholder="Enter Address"></p>
        <p><input type="text" name="maill" pattern="@gmail.com" value="<%=Model.Signup.maill%>" placeholder="Enter Email"></p>
        <p class="remember_me">
          <label>
        ...
        <p class="submit"><input type="submit" name="commit" value="Signup" onclick="ac1()"></p>
