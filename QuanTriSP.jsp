...
<html>
  ...
  <title>Điện Thoại Di Động</title>
				...
				<nav>
					<ul>
						...
						<li><a href="#">Contact</a></li>
                                                <li><a href="QuanTri.jsp">Quản Trị</a></li>
					</ul>
    ...
    <div class="login">
      ...
      <form method="post" action="TTSanPham">
        <p><input type="text" name="maspp" placeholder="Nhập Mã Sản Phẩm" value="<%=Model.TTSanPham.maspp%>"  /></p>
        <p><input type="text" name="maloaii" placeholder="Nhập Mã Loại" value="<%=Model.TTSanPham.maloaii%>"/></p>
        <p><input type="text" name="tenspp" placeholder="Nhập Tên Sản Phẩm" value="<%=Model.TTSanPham.tenspp%>" /></p>
        <p><input type="text" name="nhasxx" placeholder="Nhập Nhà Sản Xuất" value="<%=Model.TTSanPham.nhasxx%>"/></p>
        <p><input type="text" name="dongiaa"  value="<%=Model.TTSanPham.dongiaa%>"/></p>
        <p><input type="text" name="fileanhh" placeholder="Hình Ảnh" value="<%=Model.TTSanPham.fileanhh%>"/></p>
        <p class="submit">
